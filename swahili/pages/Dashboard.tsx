  ...
  return (
    <AppLayout>
      ...
      <div className="space-y-4 lg:space-y-6 mb-20 lg:mb-8">
          ...
          <SketchCard className="relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative h-3 bg-muted/30 rounded-full overflow-hidden mb-2">
                <div 
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-accent to-warning rounded-full transition-all duration-1000"
                  style={{ width: `${(userData.lessonsCompletedToday / userData.dailyGoal) * 100}%` }}
                />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Word of the Day */}
          <SketchCard className="bg-gradient-to-br from-warning/5 to-transparent border-warning/20">
            <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-center py-3">
              ...
              <p className="font-hand-secondary text-lg text-accent mb-2">{wordOfDay.english}</p>
              
              <button className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors text-sm mb-3">
                <Volume2 size={14} />
